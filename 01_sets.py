...
# in, permite sabes si un elemento se encuentra en el conjunto, la expresión se evalua como true si el elemento se
# encuentra en el conjunto y false si el elemento no se encuentra en el conjunto
...
# clear(): Elimina el contenido del conjunto
set_countries.clear()
print(set_countries)
